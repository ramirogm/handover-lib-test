...
export class HandoverPeer {
	...
	public startListening(shutdownCallback: () => Promise<void>) {
		...
		this.heartbeatClientSocket.on('message', async (msg) => {
			...
			// Avoid suicide and processing heartbeats from old instances
			if (BigInt(message.timestamp) > BigInt(this.startedAt.valueOf())) {
				...
				logger.info(
				  ...
				  // [Logs]    [7/15/2022, 2:22:08 PM] [handy] {
					// [Logs]    [7/15/2022, 2:22:08 PM] [handy]   context: { id: 'SERVER-ERROR-18-localhost-0.0.1' },
					// [Logs]    [7/15/2022, 2:22:08 PM] [handy]   message: 'Unhandled Server Error',
					// [Logs]    [7/15/2022, 2:22:08 PM] [handy]   error: [Error: ENOENT: no such file or directory, open '/data/resin-kill-me'] {
					// [Logs]    [7/15/2022, 2:22:08 PM] [handy]     errno: -2,
					// [Logs]    [7/15/2022, 2:22:08 PM] [handy]     code: 'ENOENT',
					// [Logs]    [7/15/2022, 2:22:08 PM] [handy]     syscall: 'open',
					// [Logs]    [7/15/2022, 2:22:08 PM] [handy]     path: '/data/resin-kill-me'
					// [Logs]    [7/15/2022, 2:22:08 PM] [handy]   }
					// [Logs]    [7/15/2022, 2:22:08 PM] [handy] }				
